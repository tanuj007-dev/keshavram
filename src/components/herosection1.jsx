...
export default function HeroSection1() {
  return (
    <section className="relative min-h-[600px] w-full bg-[#0A0A0A] flex flex-col justify-center items-center overflow-hidden px-4 sm:px-6 md:px-12 lg:px-24 py-16 md:py-24">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto">
        {/* Uppercase Tagline */}
        <p className="text-[10px] sm:text-xs tracking-[0.22em] font-medium text-[#A3A3A3] uppercase mb-6 sm:mb-8 select-none">
        ...
        <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-!black leading-[1.15] mb-10 sm:mb-12">
